...
Simulation <- function(
  ...
  nodes = 100,                      # number of nodes in network
  ...
  Folder = "/Output",               # sets the name of the output folder (usefull for splitting up runs)
  ...
  SimplifyCombinations = TRUE      # only allows for specific complementary combinations of norm_end_maj and norm_end_min
  ...
  # creating new folder name that is not taken yet
  
  # creating a new folder to save output in
  dir.create(paste(oldwd, Folder,sep=""), showWarnings = F)
  ...
  # cat Status
  cat(paste("\t - Created output folder at", paste(oldwd, Folder,"\n",sep="")))
